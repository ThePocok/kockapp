package hu.aranyosipeter.kockapp.model.cube;
...
import hu.aranyosipeter.kockapp.model.move.Separator;
import hu.aranyosipeter.kockapp.model.piecemap.PieceMap;
...
public abstract class Cube implements Serializable{
    ...
    public Face getFaceWithCurrentOrientation(Color faceColor) throws InvalidOrientationException {
        int rotationDegree = orientation.getRotationDegree(faceColor);
